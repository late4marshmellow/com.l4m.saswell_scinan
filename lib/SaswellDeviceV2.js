...
class SaswellDeviceV2 extends Homey.Device {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (result.result_code === '10003') {
            ...
            await sendNotification(this.homey, `Your device ${this.getName()} have issues. Please Check Homey community forum for more info!`);
  ...
  onAdded() {
    ...
    try {
      await this.setSettings({ APIVersion: 'your_value_here' });
